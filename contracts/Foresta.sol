...
contract HelloWorld is ERC721,ERC721Enumerable{
    ...
    bytes32 PROVANANCE_HASH = 0x0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef;
    ...
    function mintTree(string memory _genes,uint256 birthdate) external onlyOwner() isUnderMax(){
        _safeMint(requests[newTokenId].requesting, newTokenId);
        Tree memory tree = Tree(_genes,birthdate);
        trees.push(tree);
        newTokenId += 1;
    }
